...
public class Strings {
	...
	for (int i = 0; i <= l; i++) {
	    char first = s.charAt(i); char last = s.charAt(l-i);
	    if (first != last)
		return false;
	...
	int a = 1007;     // A tentar atribuir um número inteiro a uma String
	...
	// Converter string a minusculas
	String min = d.toLowerCase();
	System.out.println("d.toLowerCase() = " + min);
